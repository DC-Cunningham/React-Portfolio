...
A Portfolio site using React and Ionic to create a responsive site.

The application has been deployed on Heroku and is available [here](https://trundle-decade.herokuapp.com/)
...
The application is available [here](https://github.com/DCRevResLabs/React-Portfolio)
